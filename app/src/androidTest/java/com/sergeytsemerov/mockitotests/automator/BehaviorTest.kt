package com.sergeytsemerov.mockitotests.automator
...
class BehaviorTest {
    ...
    fun test_SearchIsPositive() {
        ...
        Assert.assertEquals(changedText.text.toString(), "Number of results: 697")
    }
    ...
    @Test
    fun test_DetailsScreenHasCorrectValueOfResultsAfterPositiveSearch() {
        val editText = uiDevice.findObject(By.res(packageName, "searchEditText"))
        editText.text = "UiAutomator"
        val searchButton = uiDevice.findObject(By.res(packageName, "searchButton"))
        searchButton.click()
        ...
        val toDetails = uiDevice.findObject(By.res(packageName, "toDetailsActivityButton"))
        toDetails.click()
        Assert.assertEquals(changedText.text, "Number of results: 697")
    }

    @Test
    fun test_DetailsScreenIncrementButtonClick() {
        val toDetails = uiDevice.findObject(By.res(packageName, "toDetailsActivityButton"))
        toDetails.click()
        val countZeroText =
            uiDevice.wait(
    ...
    @Test
    fun test_DetailsScreenDecrementButtonClick() {
        val toDetails = uiDevice.findObject(By.res(packageName, "toDetailsActivityButton"))
        toDetails.click()
        val countZeroText =
            uiDevice.wait(
